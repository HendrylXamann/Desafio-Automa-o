💻 Este é um código desenvolvido como parte de um desafio para uma vaga de estágio. O objetivo é demonstrar habilidades em automação de testes utilizando a biblioteca Selenium em Python.🚀
---------------------------------------------------------------------------------------------------
